...
### Важливо: Налаштування OAuth Client у Google Cloud Console

Під час створення OAuth Client у Google Cloud Console необхідно вказати в полі **Authorized redirect URIs** наступну адресу: `http://localhost:5173/auth/callback`. Зверніть увагу, що зміни можуть бути застосовані не одразу, а через кілька хвилин.
